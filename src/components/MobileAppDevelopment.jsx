    ...
    <>
      ...
      >
        ...
        <div className="mad-hero">
          <img src="./appdevelopment1.jpg" alt="Mobile App Development" />
        ...
        <div className="mad-detail-section light-bg">
          ...
          <ul>
            <li>
              <strong>1. Discovery:</strong> Understand goals, users, and challenges.
            </li>
            <li>
              <strong>2. Design:</strong> UI/UX prototypes with pixel-perfect visuals.
            </li>
            <li>
              <strong>3. Development:</strong> Agile coding with regular updates.
            </li>
            <li>
              <strong>4. Testing:</strong> QA and performance checks for flawless apps.
            </li>
            <li>
              <strong>5. Launch & Support:</strong> Deploy apps and provide long-term
              support.
            </li>
          </ul>
        </div>
        ...
        <div className="mad-detail-section dark-bg">
          <h2>Why Choose Us?</h2>
          <p>
            We combine innovation with expertise to craft apps that drive
            business growth. Whether it’s an enterprise solution or a startup MVP,
            we ensure performance, scalability, and user satisfaction.
          </p>
          <div className="mad-benefits">
            <div>
              <FaRocket /> Faster time-to-market
            </div>
            <div>
              <FaCloud /> Cloud integration
            </div>
            <div>
              <FaMobileAlt /> Responsive UI/UX
            </div>
          </div>
        </div>
        ...
        <div className="mad-cta">
          ...
          <button className="mad-btn" onClick={() => navigate("/contact")}>
            Contact Us
          </button>
        </div>
      </section>
