...
import { 
  FaTv, FaLaptop, FaChartLine, FaCloud, 
  FaHeadset, FaCode, FaMobileAlt, 
  FaWhatsapp, FaPlayCircle 
} from "react-icons/fa";
...
const Solutions = () => {
  ...
  const solutions = [
    { icon: <FaTv />, title: "IPTV Middleware Software Development", desc: "IPTV streams live and on-demand content over the internet, enhancing in-room entertainment for hotel guests.", link: "/iptv" },
    { icon: <FaMobileAlt />, title: "Mobile App Development", desc: "Custom mobile apps for hotels to enhance guest engagement, booking, and in-room service accessibility.", link: "/mobile-app" },
    { icon: <FaCode />, title: "Web Designing", desc: "Professional, responsive, and modern web design solutions to elevate hotel branding and online presence.", link: "/web-design" },
    { icon: <FaWhatsapp />, title: "WhatsApp Business API", desc: "Seamlessly connect with guests using WhatsApp Business API for instant booking confirmations, service requests, promotions, and personalized communication.", link: "/whatsapp-business" },
  ...
  return (
    <section className="solutions-slider-page">
      <h2 className="slider-title" data-aos="fade-up">Our Services</h2>
      
      <div className="solutions-slider">
        <div className="solutions-slider-track">
          {loopedSolutions.map((sol, index) => (
