...
const Iptvsection = () => {
  ...
  const handleGetAccess = () => {
    navigate("/qoute-page"); // route to your Quote page
  };
    ...
    <section className="iptv-container">
      ...
      <div className="iptv-hero">
        ...
        <div className="iptv-content" data-aos="fade-left">
          ...
          <ul className="iptv-features">
            <li>
              <FaCheckCircle className="icon-blue" /> Android Smart TVs
            </li>
            <li>
              <FaCheckCircle className="icon-blue" /> LG WebOS
            </li>
            <li>
              <FaCheckCircle className="icon-blue" /> Samsung Tizen
            </li>
            <li>
              <FaCheckCircle className="icon-blue" /> Smart OS and more
            </li>
          </ul>
      ...
      <div className="iptv-bottom">
        <div className="box white-box" data-aos="fade-up" data-aos-delay="100">
          ...
          <h3 style={{ color: "#005EB8" }}>Thousands of Channels</h3>
          <p>
            Enjoy premium sports, movies, international and regional content with
            ease.
          </p>
        </div>
        ...
        <div className="box white-box" data-aos="fade-up" data-aos-delay="200">
          ...
          <h3 style={{ color: "#005EB8" }}>Cross-Device Streaming</h3>
          <p>
            Stream on Smart TVs, Firesticks, mobile devices, desktops and more.
          </p>
        </div>

        <div className="box white-box" data-aos="fade-up" data-aos-delay="300">
          <FaTv className="box-icon" />
          <h3 style={{ color: "#005EB8" }}>Centralized Management</h3>
          <p>
            Monitor and manage all guest IPTV activity from a single backend
            dashboard.
          </p>
        </div>
      </div>
